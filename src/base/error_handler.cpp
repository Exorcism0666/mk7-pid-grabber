...
namespace CTRPluginFramework
{
    ...
    static Process::ExceptionCallbackState error_handler(ERRF_ExceptionInfo *excep, CpuRegisters *regs)
    {
        ...
        top.DrawSysfont("An error has occurred", 8, 4, Color::Red);
        ...
        top.DrawSysfont(std::format("Post it in the Discord: {}", DISCORD), 8, 160, Color::Turquoise);
        top.DrawSysfont("Press any button to return to the \uE073 HOME-Menu", 8, 200, Color::LimeGreen);
